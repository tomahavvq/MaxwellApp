...
import com.maxwell.MaxwellApp;
import com.maxwell.domain.Authority;
import com.maxwell.domain.User;
import com.maxwell.repository.AuthorityRepository;
import com.maxwell.repository.UserRepository;
import com.maxwell.security.AuthoritiesConstants;
import com.maxwell.service.MailService;
import com.maxwell.service.UserService;
import com.maxwell.web.rest.dto.ManagedUserDTO;
import com.maxwell.web.rest.dto.UserDTO;
...
/**
 * Test class for the AccountCtrl REST controller.
 *
 * @see UserService
 */
@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = MaxwellApp.class)
@WebAppConfiguration
@IntegrationTest
public class AccountCtrlIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(accountCtrl, "userRepository", userRepository);
        ReflectionTestUtils.setField(accountCtrl, "userService", userService);
        ReflectionTestUtils.setField(accountCtrl, "mailService", mockMailService);

        AccountCtrl accountUserMockResource = new AccountCtrl();
        ReflectionTestUtils.setField(accountUserMockResource, "userRepository", userRepository);
        ReflectionTestUtils.setField(accountUserMockResource, "userService", mockUserService);
        ReflectionTestUtils.setField(accountUserMockResource, "mailService", mockMailService);

        this.restMvc = MockMvcBuilders.standaloneSetup(accountCtrl).build();
