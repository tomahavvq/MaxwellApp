...
import com.maxwell.config.audit.AuditEventConverter;
import com.maxwell.domain.PersistentAuditEvent;
import com.maxwell.repository.PersistenceAuditEventRepository;
import com.maxwell.service.AuditEventService;
...
/**
 * Test class for the AuditCtrl REST controller.
 *
 */
...
public class AuditCtrlIntTest {
    ...
    public void setup() {
        ...
        AuditCtrl auditCtrl = new AuditCtrl(auditEventService);
        this.restAuditMockMvc = MockMvcBuilders.standaloneSetup(auditCtrl)
